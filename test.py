...
def load_data():
   with st.spinner(text="Loading and indexing the Documents – hang tight! This should take 1-2 minutes."):
       ...
       embed_model = GeminiEmbedding(api_key="AIzaSyAgdZA6ihanwlAdbqmPIm0WVRW4GGUlf8I")  # Fix typo
...
if "chat_engine" not in st.session_state.keys():
   ...
   llm = ChatGoogleGenerativeAI(model="gemini-pro", google_api_key="AIzaSyAgdZA6ihanwlAdbqmPIm0WVRW4GGUlf8I", temperature=0.1)
